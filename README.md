...
디렉터리 설계부터 스스로 짜보고 싶단 생각을 들게 해준 스파게티 코드의 회사 프로젝트 덕분에 이 Todo list 프로젝트를 만들어보게 되었습니다. 간단히 회고를 해보자면...
...
경험이 많지 않은 1년차 미만 개발자라 이게 정답이라고 생각하지도 않고 계속 좋은 방법을 찾아나서야겠지만 생각났던 해결 방법은..
...
ex)
UI action -> useAddTodo hooks -> useAddTodo mutation hooks -> api
